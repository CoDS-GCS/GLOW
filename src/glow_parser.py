...
parser.add_argument('--dataset_name', type=str, default='biokg', choices=['biokg','linkedIMDB','yago4-person','yago4-creativwork','crunchbase','arxiv2023','ogbnArxiv','ogbnProduct'], help="The GLOW-QA subet of questions")
